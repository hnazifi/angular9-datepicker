...
class DatePickerComponent {
     ...
     * @param {?} cd
     */
    constructor(dayPickerService, domHelper, elemRef, renderer2, utilsService, cd) {
    ...
    handleInnerElementClick(element) {
        this.handleInnerElementClickUnlisteners.push(this.renderer2.listen(element, 'click', () => {
            this.hideStateHelper = true;
        }));
    }
    /**
    ...
    startGlobalListeners() {
        this.globalListnersUnlisteners.push(this.renderer2.listen(document, 'keydown', (e) => {
            this.onKeyPress(e);
